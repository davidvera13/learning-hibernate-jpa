...
@EnableJpaRepositories(
        basePackages = "com.hibernate.jpa.repositories.cardholder",
...
public class CardHolderDatabaseConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean cardholderEntityManagerFactory(
        ...
        // fixing Caused by: org.hibernate.tool.schema.spi.SchemaManagementException:
        // Schema-validation: missing table [CreditCard]
        props.put(
