...
public class SpringbootJpaBootstrapingInitDataTest {
    ...
    void jpaSpliceTest() {
        ...
        Book book = bookRepository.save(new Book("My book", "122454678974", "Self", null));
        savedBooks.add(book);
        List<Book> books = bookRepository.saveAll(List.of(
                new Book("second book", "123456", "Myself", null),
                new Book("third book", "456789", "Myself too", null)
        ));
