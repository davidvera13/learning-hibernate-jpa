...
/**
 * we can configure table name and column names
 */
@Entity
@Table(
        name = "wp_users",
...
public class User {
    ...
    @NotNull
    @Size(max = 100)
    @Column(name = "user_nicename", length = 100)
    ...
    // name is using convention, value is not optional... we can pass optional annotation intead of column
    ...
    // Adding Bi-Directional Association
    @OneToMany
